...
local function InitRankingPaths(ui)
    return {
        ...
        RankingKey = "界面背景/排名标题/玩家值",

        PlayerRankingName = "界面背景/玩家自身排名/玩家名称",
        PlayerRankingVal = "界面背景/玩家自身排名/玩家值",
...
return ClientCustomUI.Load(script.Parent, InitRankingPaths)